...
export const RESUME_DATA: ResumeData = {
  ...
  experience: [
    ...
    {
      company: "Community Mosque (Residential Area)",
      role: "IT & Media Support (Volunteer)",
      start: "Apr 2025",
      end: "Sep 2025",
      location: "Surabaya, Indonesia",
      location_type: "Hybrid",
      link: "https://www.youtube.com/@masjidukhuwahsby",
      description: [
        "Managed end-to-end digital media workflow for mosque educational content, including recording coordination, editing, and multi-platform publishing.",
        "Oversaw YouTube, Instagram, and TikTok accounts, ensuring consistent content delivery despite irregular offline schedules.",
        "Established basic content standards such as thumbnail templates, titling, and visual consistency to improve clarity and recognition.",
        "Guided on-site volunteers in audio and video recording techniques, including microphone placement and camera angles, to maximize content quality with limited equipment.",
        "Guided on-site volunteers in audio and video recording techniques, including microphone placement and camera angles, to maximize content quality with limited equipment.",
        "Utilized AI-assisted tools to identify and extract relevant short clips while maintaining context, accuracy, and sensitivity.",
        "Contributed to increased online reach, including the growth of the YouTube channel to approximately 400 subscribers within the active period.",
      ],
    },
    {
